...
//Observer interface: each observer gets an update with a Notification printer.
class IObserver{
    public:
...
class PopUpStrategy : public INotificationStrategy{
    public:
        void sendNotification(string content) override{
            //Simulate the process of sending a popup notification.
            //representing the dispatch of messages to users via popup.
...
class NotificationEngine : public IObserver{
    ...
    public:
        ...
        void removeNotificationStrategy(INotificationStrategy* ns){
            notificationStrategies.erase(remove(notificationStrategies.begin(), notificationStrategies.end(), ns), notificationStrategies.end());
        }
...
// Any client code with interact with this service.
...
int main(){
    ...
    notificationEngine->addNotificationStrategy(new SMSStrategy("+91 9876542310"));
