...
class PremiumBurger : public Burger{
    public:
        void prepare() override{
            cout<<"Preparing Premium Burger with bun, patty, cheese, lettuce, and secret sauce!"<<endl;
        }
};
...
class PremiumWheatBurger : public Burger{
    public:
        void prepare() override{
            cout<<"Preparing Premium Wheat Burger with gourmet bun, patty, cheese, lettuce, and secret sauce!"<<endl;
        }
};
...
class BasicWheatGarlicBread : public GarlicBread{
    public:
        void prepare() override{
            cout<<"Preparing Basic Wheat Garlic Bread with garlic and butter on wheat bread!"<<endl;
        }
};
...
class CheeseWheatGarlicBread : public GarlicBread{
    public:
        void prepare() override{
            cout<<"Preparing Cheese Wheat Garlic Bread with extra cheese and butter on wheat bread!"<<endl;
        }
};
...
class MealFactory{
    public:
        ...
        virtual GarlicBread* createGarlicBread(string &type)=0;  //Pure virtual function
};
